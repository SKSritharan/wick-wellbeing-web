...
export const blogArticles: BlogArticle[] = [
  {
    ...
    excerpt:
      "Understanding how preventive healthcare measures can save lives and reduce long-term medical costs.",
    coverImage:
  ...
  },
  {
    ...
    excerpt:
      "Addressing the unique health challenges men face and encouraging proactive healthcare engagement.",
    coverImage:
  ...
  },
  {
    ...
    excerpt:
      "A comprehensive guide to minor surgical procedures performed in a GP setting and what patients should know.",
    coverImage:
  ...
  },
  {
    ...
    excerpt:
      "Exploring how lifestyle changes can be as powerful as medication in treating and preventing disease.",
    coverImage:
